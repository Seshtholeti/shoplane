...
Resources:
  ConnectContactFlowModule1:
    ...
    Properties:
      ...
      Name: VoiceToChatFlowModule1-001
      Content:
        Fn::Sub: |
          {
            "Version": "2019-10-30",
            ...
            "Actions": [
              ...
              },
              {
               ...
               { 
                 // Disconnect participant action
                 "Parameters": {}, 
                 "Identifier": "053786fc-1a9d-49bb-9f3b-0615313e7475", 
                 "Type": "DisconnectParticipant", 
                 // No transitions needed for disconnect action
                 “Transitions”: {} 
               }, 
               { 
               ...
               { 
                 // Update contact recording behavior action
  ...
  LambdaFunction1:
    ...
    Properties:
      FunctionName: Voice-to-chat-transfer-lambda01
