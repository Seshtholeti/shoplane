  ...
  ConnectContactFlowModule:
    ...
    Properties:
      ...
      Fn::Transform:
        Name: "AWS::Include"
        Parameters:
          Location: s3://v2chat-json/voicetochat-content.txt
